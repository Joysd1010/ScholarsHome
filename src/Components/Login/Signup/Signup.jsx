...
const Signup = () => {
  ...
  return (
    <div className="bg-white pt-20  px-3 md:px-20">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center ">
        <div>
          <img src="https://i.postimg.cc/VsXzWjFB/ezgif-com-optimize-1.gif" />
        </div>
        <div className="">
          ...
          <p className=" py-1 text-center text-xl">
            <small>
              ...
              <Link to="/login" className="font-semibold text-[#0171DD] ">
                Login
              </Link>
            </small>
          </p>
